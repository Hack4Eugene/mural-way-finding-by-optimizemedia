...
class w2dc_content_field_fileupload extends w2dc_content_field {
	...
	public function renderInput() {
		...
		w2dc_renderTemplate('content_fields/fields/fileupload_input.tpl.php', array('content_field' => $this, 'file' => $file));
	}
	...
	public function renderOutput($listing = null) {
		...
		w2dc_renderTemplate('content_fields/fields/fileupload_output.tpl.php', array('content_field' => $this, 'listing' => $listing, 'file' => $file));
	}
